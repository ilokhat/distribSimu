...
public class IAUIDFTaskMod {
  ...
  public static double run(File folder, File folderOut, File parameterFile,
    ...
    Map<String, List<Regulation>> map = loadRules(
        new File(folder + "/parcelle.shp"));
    ...
    System.out.println("featc size :" + featC.size());
    System.out.println("map size :" + map.size());
    System.out.println("countlrnull " + countlrnull);
    System.out.println("countlr " + countlr);
    System.out.println("env bpu :" + env.getBpU().size());
    // return (double) featC.size() / (countlr + countlrnull);
    return (double) countlr / (env.getBpU().size());
  }
